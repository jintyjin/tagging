...
class LiveRepositoryTest {
    ...
    void live_test() {
        ...
        Device device3 = new Device("nvr03", "5234", 5, "장비5", "127.0.0.5", 8085, "00:00:0c:28:05", DeviceStatus.TURN_ON);
        Device device4 = new Device("nvr04", "7234", 7, "장비7", "127.0.0.7", 8087, "00:00:0c:28:07", DeviceStatus.BROKEN);
